...
function openBookingModal(data=null) {
  ...
  document.getElementById('lmodal-oading_port').value = data?.loading_port ?? '';
...
document.getElementById('cu-booking-form').addEventListener('submit', function (e) {
    ...
    const loadingPort = document.getElementById('lmodal-oading_port').value;
  ...
  const url = bookingID ? `/bookings/update/${bookingID}/` : '/bookings/create/';
...
document.addEventListener('DOMContentLoaded', function() {
  var datepickerElement = document.getElementById('modal-ship-departure-date');
